...
import com.willcocks.callum.model.data.deserializer.ExtractionMethodDeserializer;
import com.willcocks.callum.model.util.HelperFunctions;
...
public class Selection implements Serializable {
    ...
    public void addWord(Word word, int n, int step) {
        int key = HelperFunctions.stepFunction(n, step);
